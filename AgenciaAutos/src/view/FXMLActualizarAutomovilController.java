 ...
 * @author JET
 */
public class FXMLActualizarAutomovilController implements Initializable {
    ...
    public void asignarInfo(Automovil a) {
        txtCodigo.setText(String.valueOf(a.getCodigo()));
        txtMarca.setText(a.getMarca());
        txtModelo.setText(a.getModelo());
        txtCosto.setText(String.valueOf(a.getCosto()));
        txtTipo.setText(a.getTipo());
        txtMotor.setText(a.getMotor());
        dpFecha.setValue(a.getFecha().toLocalDate());
        cbAgencia.setValue(a.getAgenciaRFC());
        cbProveedor.setValue(a.getProveedorCodigo());
    }
    
    @FXML
     public void actualizarAutomovil() throws ParseException {
        ...
        if("".equals(txtCodigo.getText()) && "".equals(txtMarca.getText()) && 
            ...
            automovilDAO.actualizarAutomovil(auto);
